...
class InfoCollection extends Backbone.Collection
  ...
  glinks: ["Alkali metal","Alkaline earth metal","Pnictogen","Chalcogen","Halogen","Noble gas","Lanthanide","Actinide","Rare earth element","Transition metal","Post-transition metal","Metalloid", "Nonmetal", "Metal"]
