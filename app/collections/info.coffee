...
class InfoCollection extends Backbone.Collection
  ...
  glinks: ["Alkali metal","Alkaline earth metal","Pnictogen","Chalcogen","Halogen","Noble gas","Lanthanoid","Actinoid","Rare earth element","Transition metal","Post-transition metal","Metalloid","Non-metal", "Metal", "Nonmetal"]
